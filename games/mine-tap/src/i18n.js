/**
 * Minimal i18n for mine-tap game
 * Main language: English. Fallback: current locale -> en -> key
 * Supported: en, es, da, ja
 */
(function (global) {
  'use strict';

  var LOCALE_KEY = 'mine-tap-locale';
  var DEFAULT_LOCALE = 'en';
  var SUPPORTED_LOCALES = ['en', 'es', 'da', 'ja'];
  var messages = {};
  ...
  function t(key, params) {
    var fallbackOrder = [currentLocale, 'en'];
    var str = null;
