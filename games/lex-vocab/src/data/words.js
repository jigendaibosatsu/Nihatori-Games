// Built-in word list for timer sessions (数百語)
export const WORD_LIST = [
  'ability', 'above', 'accept', 'according', 'achieve', 'action', 'activity', 'actually',
  'address', 'administration', 'admit', 'adult', 'affect', 'after', 'again', 'against',
  'agency', 'agent', 'agree', 'agreement', 'ahead', 'allow', 'almost', 'alone',
  'along', 'already', 'also', 'although', 'always', 'among', 'amount', 'analysis',
  'animal', 'another', 'answer', 'anyone', 'anything', 'appear', 'apply', 'approach',
  'area', 'argue', 'argument', 'around', 'arrive', 'article', 'artist', 'assume',
  'attack', 'attempt', 'attend', 'attention', 'attorney', 'audience', 'author', 'authority',
  'available', 'avoid', 'baby', 'back', 'bad', 'bag', 'ball', 'bank', 'bar', 'base',
  'battle', 'beautiful', 'because', 'become', 'before', 'begin', 'behavior', 'behind',
  'believe', 'benefit', 'best', 'better', 'between', 'beyond', 'bill', 'billion',
  'black', 'blood', 'blue', 'board', 'body', 'book', 'born', 'both', 'break', 'bring',
  'brother', 'build', 'building', 'business', 'call', 'camera', 'campaign', 'capital',
  ...
  'dinner', 'direction', 'director', 'discover', 'discuss', 'discussion', 'disease',
  ...
  'energy', 'enjoy', 'enough', 'enter', 'entire', 'environment', 'especially',
  ...
  'interest', 'interesting', 'international', 'interview', 'into', 'investment', 'involve',
  ...
  'light', 'like', 'likely', 'line', 'list', 'listen', 'little', 'live', 'local',
  ...
  'music', 'must', 'my', 'myself', 'name', 'nation', 'national', 'natural', 'nature',
  'near', 'nearly', 'necessary', 'need', 'network', 'never', 'new', 'news', 'newspaper',
  'next', 'nice', 'night', 'nine', 'none', 'nor', 'north', 'not', 'note', 'nothing',
  'notice', 'now', 'number', 'occur', 'of', 'off', 'offer', 'office', 'officer',
  'official', 'often', 'oh', 'oil', 'ok', 'old', 'on', 'once', 'one', 'only', 'onto',
  'open', 'operation', 'opportunity', 'option', 'or', 'order', 'organization', 'other',
  'others', 'our', 'out', 'outside', 'over', 'own', 'owner', 'page', 'pain', 'painting',
  'pair', 'paper', 'parent', 'part', 'participant', 'particular', 'particularly',
  'partner', 'party', 'pass', 'past', 'patient', 'pattern', 'pay', 'peace', 'people',
  'per', 'perform', 'performance', 'perhaps', 'period', 'person', 'personal',
  'phone', 'physical', 'pick', 'picture', 'piece', 'place', 'plan', 'plant', 'play',
  ...
  'rest', 'result', 'return', 'reveal', 'rich', 'right', 'rise', 'risk', 'road',
  'rock', 'role', 'room', 'rule', 'run', 'safe', 'same', 'save', 'say', 'scene',
  'school', 'science', 'scientist', 'score', 'sea', 'season', 'seat', 'second',
  'section', 'security', 'see', 'seek', 'seem', 'sell', 'send', 'senior', 'sense',
  'series', 'serious', 'serve', 'service', 'set', 'seven', 'several', 'sex', 'sexual',
  ...
  'those', 'though', 'thought', 'thousand', 'threat', 'three', 'through', 'throughout',
  ...
  'absorption', 'construction', 'development', 'environment', 'improvement',
  'establishment', 'management', 'movement', 'refreshment', 'government',
  'negation', 'unhappy', 'nonsense', 'disagree', 'unlock', 'disable',
  'extraordinary', 'education', 'beautiful', 'dangerous', 'mysterious',
  'strength', 'length', 'knowledge', 'technology', 'methodology',
  'exceptionally', 'particularly', 'traditionally', 'occasionally'
];
